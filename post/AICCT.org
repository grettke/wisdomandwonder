...
* WAIT Section: 5, Adobe Illustrator And Color Management
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-05 Sat 19:34] \\
  Watched. Minimal review. Not yet posted.
:END:
** WAIT Chapter 36. Introduction To Color Management 1:08
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-05 Sat 18:07] \\
  Watched. Minimal review. Won't yet post.
:END:

- Always consider the destination
- Management tools
- Using existing
- Creating your own
** WAIT Chapter 37. Designing With The End In Mind 6:10
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-05 Sat 18:15] \\
  Watched. Minimal review. Won't yet post.
:END:

- Out of the box you've got two color spaces
  - RGB Additive (Red, Green, Blue): Painting with Light
    - Monitors, televisions, smartphones
  - CMYK Subtractive (Cyan, Magenta, Yellow, Black): World of Absorption
    - Print, Paper
- 16 million colors
- Color Gamut: Size of spectrum aka color range
  - Monitor can do things that CMYK can't
- The colors that you see are not absorbed by the destination of the light
- Intent
  - Paper, Print \rarr CMYK
  - Monitor, Television, Smartphone \rarr RGB Additive

** WAIT Chapter 38. Managing ColorSync Settings 6:10
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-05 Sat 18:25] \\
  Watched. Minimal review. Won't yet post.
:END:
...
** WAIT Chapter 39. The Improved Illustrator Swatches Panel 2:03
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-05 Sat 18:27] \\
  Watched. Minimal review. Won't yet post.
:END:

- Dragging out swatches don't divert your eyes and it enhances your workflow

** WAIT Chapter 40. Creating Process And Global Colors 6:59
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-05 Sat 18:35] \\
  Watched. Minimal review. Won't yet post.
:END:

- AI is a document-specific program
  - Everything is saved with the document
  - Can be a hassle
  - Can be a strength
- EG: Only include desired colors
- If you have an object selected when you select a color it changes the color
  of the object
  - You can drag that selected color into the tear off
  - You can also click the new button
  - Box warns of web-unsafe. Yield warns of press-unsafe.
  - Globals are redefinable
- Can manage colors per global color and layer

** WAIT Chapter 41. Defining Spot Colors 3:27
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-05 Sat 18:39] \\
  Watched. Minimal review. Not yet posted.
:END:

- Used by 4-color presses
  - Separate plates
  - not mixed with CMYK
- Swatches: Create a custom groups for your stuff

** WAIT Chapter 42. Organizing Colors Using Groups 3:08
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-05 Sat 18:42] \\
  Watched. Minimal review. Not yet posted.
:END:

- Everything in your toolbox should be exactly where you expect it to be
  - In terms of colors
  - Using groups

** WAIT Chapter 43. Using Illustrator Color Libraries 3:29
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-05 Sat 18:46] \\
  Watched. Minimal review. Not yet posted.
:END:

- Filter group search by color percentage

** WAIT Chapter 44. Saving Custom Color Libraries 4:25
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-05 Sat 19:28] \\
  Watched. Minimal review. Not yet posted.
:END:

- Share swatch libraries by saving them
- Delete what you don't want to save
- Bulk add by selecting all objects
  - New Color Group
  - From Selected Artwork
- ASE swatch files let you share between apps in the Adobe suite

** WAIT Chapter 45. Getting Inspiration With Color Guide And Kuler 6:07
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-05 Sat 19:34] \\
...
- Pre-defined logically related for inspiration
- Kuler: online free color profile sharing site by Adobe

* WAIT Section: 6, Working With Shapes, Fills, And Strokes
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-07 Mon 20:44] \\
  Done
:END:
** WAIT Chapter 46. Introduction To Shapes, Fills, And Strokes 0:55
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-05 Sat 20:30] \\
  Watched. Notes taken. Won't yet post.
:END:

- Creating complex and really cool looking shapes using simple shapes
- Can do it mathematically
- Strokes \rarr Objects
- Make \rarr Modify \rarr Patterns

** WAIT Chapter 47. Creating Basic Shapes 10:42
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-05 Sat 20:42] \\
  Watched. Notes taken. Won't yet post.
:END:

- Object drawing 101
- Nice to see the "basics"

** WAIT Chapter 48. More On Basic Shapes 8:15
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-05 Sat 21:03] \\
  Watched. Notes taken. Won't yet post.
:END:

- Did lines and stuff
- Introduced the Stroke panel again (revisited?)

** WAIT Chapter 49. It Is All In The Math 3:57
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-05 Sat 21:08] \\
  Watched. Notes taken. Won't yet post.
:END:

- The dimensions of the last object that you created are in the buffer when
  you create new objects
- Input fields can do math

** WAIT Chapter 50. Working With Object Fills 6:07
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-05 Sat 21:15] \\
  Watched. Notes taken. Won't yet post.
:END:

- Filling helps choose those areas later

** WAIT Chapter 51. The Basics Of Object Strokes 8:17
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-05 Sat 21:30] \\
  Watched. Notes taken. Won't yet post.
:END:
...
- Stroke details totally change the look of things

** WAIT Chapter 52. Converting Strokes To Objects 3:44
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-07 Mon 20:28] \\
  Read
:END:

- Wild

** WAIT Chapter 53. Working With Gradient Fills 7:02
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-07 Mon 20:36] \\
  Watched.
:END:
...
- Opacity
- Drag modifications
- Drag custom gradients to swatches

** WAIT Chapter 54. Modifying And Creating Patterns 6:44
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-07 Mon 20:43] \\
  Watched
:END:
...
- Fun lesson!
* WAIT Section: 8, Creating And Managing Vector Shapes
:LOGBOOK:
- State "GO"         from "TODO"       [2016-11-07 Mon 22:08] \\
  Started
- State "WAIT"       from "GO"         [2016-11-07 Mon 22:08] \\
  Done for now.
:END:
** WAIT Chapter 61. Introduction To Vector Shapes 0:54
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-07 Mon 20:54] \\
  Watched.
:END:

- Managing and building shapes
- Symbol creation and management

** WAIT Chapter 62. Switching Drawing Modes 8:46
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-07 Mon 21:03] \\
  Watched.
:END:

- Stacking order
- /Can/ used layers to define z-order
- Object \rarr Arrange \rarr Send to [front, back]
  - Define Z-order
  - On leftmost panel
- Draw inside!
- Fascinating

** WAIT Chapter 63. Working With Pathfinder Tools 10:05
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-07 Mon 21:20] \\
  Watched.
:END:

- Pathfinders critically important
- Divide
  - Looks at one object
  - Have to be objects
  - Looks at an object underneath it at any depth
  - Cuts at intersection if any
- Trim
  - Object top is the trimmer
  - Object on bottom is the trimmee
  - Select both
- Merge
  - Merge merges same fill colors together
  - If they are different they are separated
- Crop
  - Keeps the intersection from the bottom
  - Works for two shapes: top and bottom
    - Only works well with two
- Outline
  - Create the outline of any object easily
  - Can modify the stroke
  - Stroke is based on original colors
- Minus Back
  - Keep only the top with intersections bit off

** WAIT Chapter 64. Using Shape Mode Tools 5:20
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-07 Mon 21:27] \\
  Watched.
:END:

- Unite
  - Makes multiple selected objects into one
  - Shape that is on top influences everything else
    - Fill color fills everything else
- Minus Front
  - Cuts top out of bottom
- Intersection
  - Include the AND of both of them
- Exclude
  - Remove any AND
    - Neat effect
- Wild

** WAIT Chapter 65. Working With The New Live Corners 4:37
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-07 Mon 21:34] \\
  Watched.
:END:

- Visually modify corners
- Select individual corners to modify them using the direct select and live corner
- Organic live involvement WYSIWYG

** WAIT Chapter 66. Understanding The Shape Builder Tool 3:12
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-07 Mon 21:38] \\
  Watched.
:END:

- Add things together or remove parts without using the Pathfinder
  - Gives more control
  - Though Pathfinder is pretty precise
- Manual uniting
  - Precise control of which objects
- Awesome tool

** WAIT Chapter 67. Using The Symbol Sprayer 7:37
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-07 Mon 21:46] \\
  Watched.
:END:

- Good to know

** WAIT Chapter 68. Creating Custom Symbols 5:08
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-07 Mon 22:08] \\
  Watched.
:END:

- Symbols are per document
- This lesson shows how to create them
- One way: draw it on the screen and save it as a symbol
- Another way: start with a symbol that you like and modify it
...
:PROPERTIES:
:ID:       o2b:B30DCD1D-667E-49BE-99D7-D0BF1B96FD52
:POST_DATE: [2017-02-04 Sat 14:33]
:POSTID:   10517
:BLOG:     wisdomandwonder
:END:
...
** WAIT Chapter 126. Introduction To Saving And Printing 1:10
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-07 Mon 22:18] \\
  Watched.
:END:
...
** WAIT Chapter 127. Saving For The Web And Beyond 10:14
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-07 Mon 22:31] \\
  Watched.
:END:

- Save for Web is now legacy
- Use Save for Screens instead

** WAIT Chapter 128. Tweaking The Final Product 10:48
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-07 Mon 22:52] \\
  Watched.
:END:

- More options

** WAIT Chapter 129. Saving An Illustrator Document 4:29
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-07 Mon 22:56] \\
  Watched.
:END:

- Four color presses like Illustrator EPS
- Illustrator Template if you want to use a document over and over again
  - Is this a re-use thing? What problem does this solve?
- Specify document raster effect (DRE) settings for press quality
  - Avoid warnings for too small DPI

** WAIT Chapter 130. Outputting Directly To Print 7:57
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-07 Mon 23:05] \\
  Watched.
:END:

- DRE settings are important
- Andy uses
  - Printer profile: ProPhoto RBG
  - Rendering Intent: Relative Colormetric
- Explained a lot about printing

** WAIT Chapter 131. Generating A Document Package 2:40
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-07 Mon 23:14] \\
  Watched.
:END:

- Can't export TypeKit fonts

** WAIT Chapter 132. Final Thoughts 2:51
:PROPERTIES:
:END:
:LOGBOOK:
- State "WAIT"       from "TODO"       [2016-11-07 Mon 23:15] \\
  Watched.
:END:

- Nice wrapup
- Nice lighting, video, rhythm, meter, voice, approach and class
